...
```{=html}
<iframe src="https://padlet.com/embed/bsn6i0kv2ibc2f46" frameborder="0" allow="camera;microphone;geolocation;display-capture;clipboard-write" style="width:100%;
             height:600px;
             display:block;
             padding:0;
             margin:0">
...
```{=html}
<iframe src="https://padlet.com/embed/1l22vqkiu4ih14qo" frameborder="0" allow="camera;microphone;geolocation;display-capture;clipboard-write" style="width:100%;
             height:600px;
             display:block;
             padding:0;
             margin:0">
