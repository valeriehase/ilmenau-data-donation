...
format:
  revealjs:
    footer: "Introduction to Data Donation - TU Ilmenau - Valerie Hase"
...
<h1>Introduction to Data Donation</h1>

<h3>Workshop TU Ilmenau 2026</h3>
...
```{=html}
<iframe src="https://padlet.com/embed/bi9qxgz5da9yhi89" frameborder="0" allow="camera;microphone;geolocation;display-capture;clipboard-write" style="width:100%;
             height:600px;
             display:block;
             padding:0;
             margin:0">
...
*Download the "Data for Task 4" from the website or use your own YouTube watch history. Also, load the respective R-code. Run the code (you just have to change the location and name of your data)*:
:::
